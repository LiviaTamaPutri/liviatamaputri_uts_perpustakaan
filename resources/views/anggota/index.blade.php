            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('anggota.create') }}" class="btn btn-md btn-primary mb-3">Tambah Anggota</a>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">No.</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $anggota->email }}</td>
                                    <td>
                                        <a href="{{ route('anggota.edit', $anggota->id_anggota) }}" class="btn btn-warning btn-sm">Edit</a>
